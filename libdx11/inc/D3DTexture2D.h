...
namespace NARCO
{
	...
	public:
		...
		NARCO_API D3DTexture2DArray(ID3D11Device* device, DXGI_FORMAT format, unsigned int arraySize, unsigned int bindFlag, D3D11_USAGE usage, unsigned int width, unsigned int height, unsigned int mipLevels, unsigned int cpuAccessFlag = 0);
		NARCO_API ~D3DTexture2DArray();
